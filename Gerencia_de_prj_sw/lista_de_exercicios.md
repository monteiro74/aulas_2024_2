...
1. Elaborar um cronograma para o desenvolvimento de software com aproximadamente 15 tarefas.
...
2. Configure com a conta de administrador sue qdPM. Captuere as telas "Project Status", "Task Status", "Ticket Status". Na captura de tela deverá constar a url do seu navegador e data e hora do windows (capture a tela completa). Coloque essas 2 telas no seu repositório no github compartilhado com o professor.<br>
