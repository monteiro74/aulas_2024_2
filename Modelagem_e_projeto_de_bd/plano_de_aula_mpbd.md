...
| Aula 5:  (19/09/2024) | 3hs | **Avaliação 1**. [Curso fundamental de Scriptcase](https://www.scriptcase.com.br/aprendizagem/cursos/scriptcase-fundamental/) e [Documentação do Scriptcase](https://www.scriptcase.com.br/docs/pt_br/v9/manual/01-introducao/01-visao-geral/). Normalização. Revisão de modelo ER. |
| Aula 6:  (26/09/2024) | 3hs | Objetos do banco de dados. Conexão ODBC. Conexão do Excel com SQL Server. |
