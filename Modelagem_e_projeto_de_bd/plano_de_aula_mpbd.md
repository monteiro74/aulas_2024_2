...
| Aula 9: (24/10/2024) | 3hs | Introdução aos bancos NoSQL: [CouchDB](https://couchdb.apache.org/) e [MongoDB](https://www.mongodb.com/products/self-managed/community-edition). Revisão para prova. Arquivos em json estão disponíveis nesta página.|
