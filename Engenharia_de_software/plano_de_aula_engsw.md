...
| Aula 6: (24/09/2024)  | 3hs | Revisão do repositórios e suas etapas, desenvolvimento do diagrama de casos de uso e histórias de usuário. Desenvolvimento de projeto (pet shop) com ferramenta IDE RAD (telas, gráficos, menu). |
| Aula 7: (01/10/2024)  | 3hs | Finalização de projeto com ferramenta IDE RAD (comentários sobre relatórios, consulta, form blank, dashboard, módulo de segurança, deploy no apache (laragon)). [Publicação de aplicação](https://www.youtube.com/watch?v=Oa0Lk6RvRoc). [+info sobre publicação](https://www.youtube.com/watch?v=SqbfN11HrCE). |
